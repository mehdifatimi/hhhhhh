...
@section('title', $quiz->title . ' - Mode Invité')
...
<div class="quiz-play-container">
    <div class="container py-5">
        <div class="quiz-header">
            <h1>{{ $quiz->title }}</h1>
            <p class="guest-mode-badge">Mode Invité</p>
        ...
        @if($questions->count() > 0 && $currentQuestionIndex < $questions->count())
            ...
            <div class="question-card">
                ...
                <form action="{{ route('quizzes.submit.guest', $quiz->id) }}" method="POST">
                    @csrf
            ...
            <div class="guest-notice mt-4">
                <p>Vous jouez en tant qu'invité. <a href="{{ route('login') }}">Connectez-vous</a> ou <a href="{{ route('register') }}">créez un compte</a> pour enregistrer vos résultats et suivre votre progression.</p>
            </div>
        @else
