...
@section('title', 'Résultats du Quiz - Mode Invité')
...
<div class="result-container">
    <div class="container py-5">
        <div class="result-header">
            ...
            <span class="guest-mode-badge">Mode Invité</span>
            <a href="{{ route('browse') }}" class="btn btn-outline-primary">
                <i class="fas fa-arrow-left"></i> Parcourir les quiz
            </a>
        </div>
        ...
        <div class="result-card">
            ...
            <div class="result-details">
                ...
                <div class="guest-account-prompt">
                    <p>Créez un compte pour enregistrer vos résultats et suivre votre progression!</p>
        ...
        <div class="answers-review">
            ...
            @foreach($attempt->quiz->questions as $index => $question)
                @php
                    $userAnswerIds = $attempt->userAnswers->where('question_id', $question->id)->pluck('answer_id')->toArray();
        ...
        <div class="result-actions">
            <a href="{{ route('quizzes.play.guest', $attempt->quiz->id) }}" class="btn btn-primary">Réessayer ce quiz</a>
            <a href="{{ route('browse') }}" class="btn btn-secondary">Explorer d'autres quiz</a>
        </div>
    </div>
</div>
@endsection
